...
restaurant1 = Restaurant(user_id=1, name="Urban Burger", picture="/img/a.jpg")
...
restaurant2 = Restaurant(user_id=1, name="Super Stir Fry", picture="/img/b.jpg")
...
restaurant1 = Restaurant(user_id=1, name="Panda Garden", picture="/img/c.jpg")
...
restaurant1 = Restaurant(user_id=1, name="Thyme for That Vegetarian Cuisine ", picture="/img/d.jpg")
...
restaurant1 = Restaurant(user_id=1, name="Tony\'s Bistro ", picture="/img/e.jpg")
...
# Menu for Andala's
restaurant1 = Restaurant(user_id=1, name="Andala\'s", picture="/img/f.jpg")
...
restaurant1 = Restaurant(user_id=1, name="Auntie Ann\'s Diner' ", picture="/img/g.jpg")
...
restaurant1 = Restaurant(user_id=1, name="Cocina Y Amor ", picture="/img/h.png")
...
restaurant1 = Restaurant(user_id=1, name="State Bird Provisions", picture="/img/i.jpg")
session.add(restaurant1)
session.commit()
